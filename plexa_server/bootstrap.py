...
PRODUCTION_ENV_TEMPLATE_VALUES = {
    ...
    "PLEXA_AUTH_ISSUER": "https://login.example.com",
    "PLEXA_AUTH_AUDIENCE": "plexa-api",
    "PLEXA_AUTH_JWKS_URL": "https://login.example.com/.well-known/jwks.json",
    ...
    "PLEXA_CONTENT_RETENTION_DAYS": "365",
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Deprecated 0.1.x alias: import the default legacy filesystem data "
            "after initializing requested databases."
        ),
    )
    parser.add_argument(
        "--init-test",

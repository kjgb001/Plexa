...
[plexa_client](../../../modules.md) / [api/errors](../README.md) / NotFoundError

# Class: NotFoundError

Defined in: [src/api/errors.ts:12](https://github.com/kjgb001/Plexa/blob/ef825c87ddfab1b3ad678ff32fe58cc3c1525369/plexa_client/src/api/errors.ts#L12)
...
> **new NotFoundError**(`status`, `detail?`): `NotFoundError`

...
[plexa_client](../../../modules.md) / [api/errors](../README.md) / UnauthorizedError

# Class: UnauthorizedError

Defined in: [src/api/errors.ts:13](https://github.com/kjgb001/Plexa/blob/ef825c87ddfab1b3ad678ff32fe58cc3c1525369/plexa_client/src/api/errors.ts#L13)
...
> **new UnauthorizedError**(`status`, `detail?`): `UnauthorizedError`
